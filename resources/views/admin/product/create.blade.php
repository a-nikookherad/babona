    ...
    <form id="kt_ecommerce_add_product_form" class="form d-flex flex-column flex-lg-row" data-kt-redirect="../../demo1/dist/apps/ecommerce/catalog/products.html">
        ...
        <div class="d-flex flex-column gap-7 gap-lg-10 w-100 w-lg-300px mb-7 me-lg-10">
            ...
            <div class="card card-flush py-4">
                ...
                <!--begin::کارت body-->
                <div class="card-body pt-0">
                    <span class="text-muted">اطلاعاتی موجود نیست. پس از انتشار محصول، داده های فروش شروع به ضبط می کنند.</span>
                </div>
                <!--end::کارت body-->
            </div>
            <!--end::هفتهly sales-->
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body pt-0">
                                ...
                                <div class="mb-10 fv-row">
                                    ...
                                    <!--end::Tags-->
                                    <!--begin::Input-->
                                    <input type="text" name="product_name" class="form-control mb-2" placeholder="نام محصول" value="" />
                                    <!--end::Input-->
                                    <!--begin::توضیحات-->
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body pt-0">
                                ...
                                <div class="mb-10 fv-row">
                                    ...
                                    <!--end::Tags-->
                                    <!--begin::Input-->
                                    <input type="text" name="price" class="form-control mb-2" placeholder="قیمت محصول" value="" />
                                    <!--end::Input-->
                                    <!--begin::توضیحات-->
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body pt-0">
                                ...
                                <div class="mb-10 fv-row">
                                    ...
                                    <!--end::Tags-->
                                    <!--begin::Input-->
                                    <input type="text" name="sku" class="form-control mb-2" placeholder="کد محصول را وارد کنید" value="" />
                                    <!--end::Input-->
                                    <!--begin::توضیحات-->
                                ...
                                <div class="mb-10 fv-row">
                                    ...
                                    <div class="d-flex gap-3">
                                        <input type="number" name="shelf" class="form-control mb-2" placeholder="روی طبقه" value="" />
