        ...
        <div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper hover-scroll-overlay-y my-5"
            ...
            <div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu"
                ...
                <div data-kt-menu-trigger="click"
                     class="menu-item here @if (request()->routeIs('dashboard')) {{"show"}} @endif menu-accordion">
                    <!--begin:Menu link-->
                ...
                <!--begin:Menu item-->
                <div data-kt-menu-trigger="click"
                     class="menu-item menu-accordion @if (request()->routeIs('production.*')) {{"hover show"}} @endif">
                    <!--begin:Menu link-->
                    <span class="menu-link">
											<span class="menu-icon">
                    ...
                    <!--end:Menu link-->
                    <!--begin:Menu sub-->
                    <div class="menu-sub menu-sub-accordion @if(request()->routeIs('production.*')) {{"show"}} @endif">
                        <!--begin:Menu item-->
                        <div data-kt-menu-trigger="click"
                             class="menu-item menu-accordion @if(request()->routeIs('production.*')) {{"hover show"}} @endif ">
                            <!--begin:Menu link-->
                            ...
                            <!--begin:Menu sub-->
                            <div
                                class="menu-sub menu-sub-accordion @if(request()->routeIs('production.categories.*')) {{"show"}} @endif">
                                <!--begin:Menu item-->
                                <div class="menu-item">
                                    <!--begin:Menu link-->
                                    <a class="menu-link @if (request()->routeIs('production.categories.list')) {{"active"}} @endif"
                                       href="{{route("production.categories.list")}}">
															<span class="menu-bullet">
																<span class="bullet bullet-dot"></span>
															</span>
                                ...
                                <div class="menu-item">
                                    <!--begin:Menu link-->
                                    <a class="menu-link @if (request()->routeIs('production.categories.create')) {{"active"}} @endif"
                                ...
                                <div class="menu-item">
                                    <!--begin:Menu link-->
                                    <a class="menu-link @if (request()->routeIs('production.products.list')) {{"active"}} @endif"
                                       href="{{route("production.products.list")}}">
															<span class="menu-bullet">
																<span class="bullet bullet-dot"></span>
															</span>
