                    ...
                    @foreach($products as $product)
                        @foreach($product->productDetails as $productDetails)
                            <tr>
                                ...
                                <td class="text-end pe-0">
                                    {{--@php
                                        \Illuminate\Support\Number::format($productDetails->price);
                                    @endphp--}}
                                ...
                                <td class="text-end pe-0"
                                    ...
                                    <!--begin::Badges-->
                                    <div
                                        class="badge badge-light-danger">{{$product->status?\Production\Production::$mapStatus[$product->status]:"تایین نشده"}}</div>
                                    <!--end::Badges-->
                                </td>
                                <!--end::وضعیت=-->
                                <!--begin::عملیات=-->
                                <td class="text-end">
                                    ...
                                    <div
                                        ...
                                        <!--begin::Menu item-->
                                        <div class="menu-item px-3">
                                            <a href="{{route("production.products.delete",["id"=>$product->id])}}"
                                               class="menu-link px-3"
