...
<link rel="stylesheet" type="text/css" href="{{asset("shop/styles/contact_styles.css")}}">
...
<script src="{{asset("shop/https://maps.googleapis.com/maps/api/js?v=3.exp&key=AIzaSyCIwF204lFZg1y4kPSIhKaHEXMLYxxuMhA")}}"></script>
<script src="{{asset("shop/plugins/jquery-ui-1.12.1.custom/jquery-ui.js")}}"></script>
<script src="{{asset("shop/js/contact_custom.js")}}"></script>
</body>
