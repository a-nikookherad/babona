    ...
    <div class="card card-flush">
        ...
        <div class="card-header align-items-center py-5 gap-2 gap-md-5">
            ...
            <div class="card-toolbar">
                <!--begin::Add customer-->
                <a href="../../demo1/dist/apps/ecommerce/catalog/add-category.html" class="btn btn-primary">افزودن دسته
                    بندی</a>
                <!--end::Add customer-->
            </div>
            <!--end::کارت toolbar-->
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer"
                        ...
                        <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                            ...
                            <th class="min-w-150px sorting" tabindex="0" aria-controls="kt_ecommerce_category_table"
                                rowspan="1" colspan="1" aria-label="دسته بندی نوع: activate to sort column ascending"
                                style="width: 200.219px;">دسته بندی نوع
                            </th>
                            <th class="text-end min-w-70px sorting_disabled" rowspan="1" colspan="1" aria-label="عملیات"
